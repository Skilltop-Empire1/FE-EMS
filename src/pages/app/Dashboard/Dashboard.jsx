...
const Dashboard = () => {
  ...
  } = useFetchResourceQuery("/staff/doctor/all");
  const {
    data: nurseList,
    error: nurseError,
    isLoading: nurseLoading,
  } = useFetchResourceQuery("/staff/nurses/all");
  const {
    data: appointmentList,
    error: appointmentError,
    isLoading: appointmentLoading,
  } = useFetchResourceQuery("/appointment");
  const {
    data: departmentList,
              ...
              <tbody>
                {appointmentLoading ? (
                  ...
                  appointmentList?.appointments
                    ...
                    .slice(
                      appointmentList?.appointments.length - 5,
